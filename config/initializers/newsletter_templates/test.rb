Decidim.content_blocks.register(:newsletter_template, :test) do |content_block|
  content_block.cell = "decidim/newsletter_templates/test"
  content_block.settings_form_cell = "decidim/newsletter_templates/test_settings_form"
  content_block.public_name_key = "decidim.newsletter_templates.test.name"
  ...
  t = -> (key) { I18n.t("decidim.newsletter_templates.test.#{key}") }
